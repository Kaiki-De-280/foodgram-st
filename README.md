...
Для импорта продуктов из json-фикстуры из прекода используйте в директории ```infra/``` команду: ```docker-compose exec backend python manage.py loaddata ingredients.json```
